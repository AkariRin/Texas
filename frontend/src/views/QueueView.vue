      ...
      <v-col cols="12">
        <v-card>
          <v-card-title class="d-flex align-center ga-2">
            ...
            <v-spacer />
            <v-btn-toggle v-model="taskFilter" density="compact" variant="outlined" divided>
          ...
          >
            <template #item.category="{ item }">
              <v-chip :color="categoryColor(item.category)" size="small" variant="tonal">
            ...
            <template #item.schedule="{ item }">
              <v-chip v-if="item.schedule" color="purple" size="small" variant="tonal">
                {{ item.schedule }}
              </v-chip>
            ...
            <template #item.started="{ item }">
              <v-chip v-if="item.started" size="x-small" color="blue" variant="tonal">
